...
class TestCheckout():
    ...
    def test_checkout3_1Fcorrect(self):
        assert CheckoutSolution().checkout("F")==10
        
    def test_checkout3_2Fcorrect(self):
        assert CheckoutSolution().checkout("FF")==20

    def test_checkout3_3Fcorrect(self):
        assert CheckoutSolution().checkout("FFF")==20

    def test_checkout3_1A3Fcorrect(self):
        assert CheckoutSolution().checkout("AFFF")==70
        
    def test_checkout3_1A5Fcorrect(self):
        assert CheckoutSolution().checkout("AFFFFF")==90

    def test_checkout3_4Fcorrect(self):
